    <div class="page-body">
                ...
                <div class="card-body">
                    <div class="card-header">
                        ...
                        <div class="text-end col">
                            <button data-bs-toggle="modal" data-bs-target="#modal-alumnos" class="btn btn-primary">Subir nueva lista</button>
                            ...
                            <tbody>
                                ...
                                if ($selAlumno->rowCount() > 0) {
                                    ...
                                    while ($selAlumnoRow = $selAlumno->fetch(PDO::FETCH_ASSOC)) {
                                        ?>
                                        <tr>
                                            <td><?php echo $selAlumnoRow['matricula']; ?></td>
                                            <td><?php echo $selAlumnoRow['nombre']; ?></td>
                                            <td><?php echo $selAlumnoRow['app'] . " " . $selAlumnoRow['apm']; ?></td>
                                            <td><?php echo $selAlumnoRow['telefono']; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalVerAlumno<?php echo $selAlumnoRow['id_alumno']; ?>">
                                                    Ver
                                                </button>
                                                <button type="button" class="btn btn-primary btn-sm btn-editar" data-bs-toggle="modal" data-bs-target="#modalEditarAlumno" data-id="<?php echo $selAlumnoRow['id_alumno']; ?>">
        Editar
    </button>
        ...
        if ($selAlumno->rowCount() > 0) {
            while ($selAlumnoRow = $selAlumno->fetch(PDO::FETCH_ASSOC)) {
                ?>
                <div class="modal fade" id="modalVerAlumno<?php echo $selAlumnoRow['id_alumno']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p><strong>Matrícula:</strong> <?php echo $selAlumnoRow['matricula']; ?></p>
                                <p><strong>Nombre:</strong> <?php echo $selAlumnoRow['nombre']; ?></p>
                                <p><strong>Apellidos:</strong> <?php echo $selAlumnoRow['app'] . " " . $selAlumnoRow['apm']; ?></p>
                                <p><strong>Correo:</strong> <?php echo $selAlumnoRow['correo']; ?></p>
                                <p><strong>Teléfono:</strong> <?php echo $selAlumnoRow['telefono']; ?></p>
                            </div>
