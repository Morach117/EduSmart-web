...
<body>
  ...
  <div class="page">
    ...
    <div class="modal modal-blur fade" id="modal-team" data-bs-toggle="static" tabindex="-1" role="dialog"
      aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Cargar lista de alumnos</h5>
            <!-- boton de descarga para la plantilla csv -->
          ...
          <div class="modal-footer">
            <div class="container text-end">
              <!-- boton cancelar el cual cierra y recarga la pagina  -->
